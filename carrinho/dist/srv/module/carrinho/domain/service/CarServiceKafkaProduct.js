...
exports.startConsumerProduct = startConsumerProduct;
const KafkaClient_1 = require("../../infra/kafka/KafkaClient");
const redisClient_1 = require("../../infra/redis/redisClient");
async function startConsumerProduct() {
    try {
        const redis = redisClient_1.RedisClient.getInstance();
        const kafka = KafkaClient_1.KafkaClient.getInstance();
        console.log("chegou");
...
//# sourceMappingURL=CarServiceKafkaProduct.js.map