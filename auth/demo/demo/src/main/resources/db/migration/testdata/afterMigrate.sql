...
lock tables cidade write, cozinha write, estado write, forma_pagamento write,
	...
	produto write, restaurante write, restaurante_forma_pagamento write, usuario write, usuario_grupo write, oauth2_registered_client write,
	oauth2_authorization write, oauth2_authorization_consent write, foto_produto write; 
...
alter table oauth2_authorization auto_increment = 1;
alter table oauth2_authorization_consent auto_increment = 1;
alter table produto auto_increment = 1;
...
insert into usuario (nome,email,senha,data_cadastro ) values("debora","debora@gmail.com","$2a$10$aW6FImlJA1AqSdAsgNv9kOyMYMP2Eh06haocDbVpHKp5PTYOdjw2C",UTC_TIMESTAMP());
